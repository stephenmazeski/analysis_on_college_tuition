...
```{r}
#IncomeByState <- (Untitled.spreadsheet...StateIncome)
#TuitionByState <- (Untitled.spreadsheet...StateTuitionPrice)

#mergedBYSTATE <- merge(IncomeByState, TuitionByState)
#head(mergedBYSTATE)
```
```{r}
#plot_usmap("states", data = mergedBYSTATE, values = IncomeByState) +ggplot2::scale_fill_continuous(low = "green", high = "red", guide = FALSE)
#plot_usmap("states")
```
