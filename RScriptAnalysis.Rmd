...
g + ylab("Household Income by Class") + scale_shape_discrete() + labs(title = "Wages by Five Distinct Classes in the US", caption = "Based on data from The US Census Bureau")
```
